...
export const Home = () => {
  ...
  return (
    <>
      ...
      <h1 className="text-center mt-4 mb-5 text-xl font-bold">Fariha If you are seeing this please activate your Twitter or create a new Twitter please please please, you know I'm feeling suffocated</h1>
